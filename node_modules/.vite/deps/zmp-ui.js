...
var Password = import_react19.default.forwardRef(function(props, ref) {
  ...
  var renderPassword = function renderPassword2() {
    ...
    var omittedProps = _objectSpread3(_objectSpread3({}, omit(restProps, ["suffix", "iconRender"])), {}, {
...
var Avatar = import_react25.default.forwardRef(function(props, ref) {
  ...
  var avatarStyle = {};
  if (style) {
    avatarStyle = _objectSpread4({}, style);
  }
  if (size) {
    avatarStyle = _objectSpread4(_objectSpread4({}, avatarStyle), {}, {
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react31.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react31.default.createElement(Component2, props, children2));
  };
...
var Content = import_react35.default.forwardRef(function(props, ref) {
  ...
  if (modalStyle) {
    modalContentStyle = _objectSpread5({}, modalStyle);
  }
  if (height) {
...
var withAnimated = (Component2, host2) => {
  ...
  return (0, import_react40.forwardRef)((givenProps, givenRef) => {
    ...
    return React41.createElement(Component2, _extends3({}, usedProps, {
      ref
    }));
  });
};
...
var Content2 = (0, import_react43.forwardRef)(function(props, ref) {
  ...
  var animationConfig = _objectSpread7(_objectSpread7({}, config.stiff), {}, {
  ...
  var _useSpring = useSpring(function() {
    return {
      ...
      movingAmount: 0,
      config: _objectSpread7({}, animationConfig)
    };
  ...
  var handlerDrag = function handlerDrag2(_ref2) {
    var isDragging = _ref2.down, first = _ref2.first, _ref2$velocity = _ref2.velocity, _vy = _ref2$velocity[1], movementValues = _ref2.movement, event = _ref2.event, memo2 = _ref2.memo;
    set({
      down: isDragging,
...
var Action = import_react46.default.forwardRef(function(props, ref) {
...
var action_sheet_default = Action;
...
var Tab = import_react48.default.forwardRef(function(props, ref) {
  ...
  return import_react48.default.createElement("div", {
    ...
    "aria-hidden": !active,
    style: _objectSpread8(_objectSpread8({}, mergedStyle), style),
    ref,
    className: cls
...
var Tabs = import_react54.default.forwardRef(function(props, ref) {
  ...
  var tabbarProps = _objectSpread10(_objectSpread10({}, sharedProps), {}, {
...
// node_modules/zmp-ui/node_modules/react-router-dom/dist/index.js
var React54 = __toESM(require_react());
var ReactDOM3 = __toESM(require_react_dom());

// node_modules/zmp-ui/node_modules/react-router/dist/index.js
...
function createMemoryHistory(options) {
  ...
  function createMemoryLocation(to3, state, key) {
    if (state === void 0) {
      state = null;
    }
    let location = createLocation(entries ? getCurrentLocation().pathname : "/", to3, state, key);
    warning(location.pathname.charAt(0) === "/", "relative pathnames are not supported in memory history: " + JSON.stringify(to3));
    return location;
  }
  ...
  let history = {
    ...
    createHref,
    createURL(to3) {
      return new URL(createHref(to3), "http://localhost");
    },
    encodeLocation(to3) {
      let path = typeof to3 === "string" ? parsePath(to3) : to3;
      return {
    ...
    push(to3, state) {
      action = Action2.Push;
      let nextLocation = createMemoryLocation(to3, state);
      index2 += 1;
...
var DataRouterContext = React53.createContext(null);
if (true) {
  DataRouterContext.displayName = "DataRouter";
}
var DataRouterStateContext = React53.createContext(null);
if (true) {
  DataRouterStateContext.displayName = "DataRouterState";
}
var AwaitContext = React53.createContext(null);
if (true) {
  AwaitContext.displayName = "Await";
}
var NavigationContext = React53.createContext(null);
if (true) {
  NavigationContext.displayName = "Navigation";
}
var LocationContext = React53.createContext(null);
if (true) {
  LocationContext.displayName = "Location";
}
var RouteContext = React53.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
...
var RouteErrorContext = React53.createContext(null);
if (true) {
...
function useHref(to3, _temp) {
  ...
  } = React53.useContext(NavigationContext);
  let {
    hash,
    pathname,
    search
...
function useInRouterContext() {
  return React53.useContext(LocationContext) != null;
}
function useLocation() {
  ...
  return React53.useContext(LocationContext).location;
}
function useNavigationType() {
  return React53.useContext(LocationContext).navigationType;
}
var navigateEffectWarning = "You should call navigate() in a React.useEffect(), not when your component is first rendered.";
function useIsomorphicLayoutEffect2(cb) {
  let isStatic = React53.useContext(NavigationContext).static;
  if (!isStatic) {
    React53.useLayoutEffect(cb);
  }
}
function useNavigate() {
  let {
    isDataRoute
  } = React53.useContext(RouteContext);
...
function useNavigateUnstable() {
  ...
  let dataRouterContext = React53.useContext(DataRouterContext);
  let {
    basename,
    future,
    navigator: navigator2
  ...
  let activeRef = React53.useRef(false);
  useIsomorphicLayoutEffect2(() => {
    activeRef.current = true;
  });
  let navigate = React53.useCallback(function(to3, options) {
    if (options === void 0) {
      options = {};
    }
...
var OutletContext = React53.createContext(null);
function useParams() {
  let {
    matches
  } = React53.useContext(RouteContext);
...
function useResolvedPath(to3, _temp2) {
  ...
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches, future.v7_relativeSplatPath));
  return React53.useMemo(() => resolveTo(to3, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to3, routePathnamesJson, locationPathname, relative]);
}
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg && renderedMatches) {
    return React53.createElement(LocationContext.Provider, {
      value: {
        location: _extends6({
          pathname: "/",
          search: "",
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = React53.createElement(React53.Fragment, null, React53.createElement("p", null, "💿 Hey developer 👋"), React53.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", React53.createElement("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", React53.createElement("code", {
      style: codeStyles
    }, "errorElement"), " prop on your route."));
  }
  return React53.createElement(React53.Fragment, null, React53.createElement("h2", null, "Unexpected Application Error!"), React53.createElement("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? React53.createElement("pre", {
    style: preStyles
  }, stack) : null, devInfo);
}
var defaultErrorElement = React53.createElement(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends React53.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return this.state.error !== void 0 ? React53.createElement(RouteContext.Provider, {
      value: this.props.routeContext
    }, React53.createElement(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  return React53.createElement(RouteContext.Provider, {
    value: routeContext
  }, children2);
}
  ...
  return renderedMatches.reduceRight((outlet, match, index2) => {
    ...
    let getChildren = () => {
      ...
      if (error) {
        ...
        children2 = React53.createElement(match.route.Component, null);
      } else if (match.route.element) {
        children2 = match.route.element;
      } else {
        children2 = outlet;
      }
      return React53.createElement(RenderedRoute, {
        match,
        routeContext: {
          outlet,
          matches: matches2,
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index2 === 0) ? React53.createElement(RenderErrorBoundary, {
...
function useDataRouterContext(hookName) {
  let ctx2 = React53.useContext(DataRouterContext);
  !ctx2 ? true ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return ctx2;
}
function useDataRouterState(hookName) {
  let state = React53.useContext(DataRouterStateContext);
  !state ? true ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = React53.useContext(RouteContext);
...
function useMatches() {
  ...
  return React53.useMemo(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
function useRouteError() {
  var _state$errors;
  let error = React53.useContext(RouteErrorContext);
...
var startTransitionImpl = React53[START_TRANSITION];
function MemoryRouter(_ref3) {
  ...
  let [state, setStateImpl] = React53.useState({
  ...
  let setState = React53.useCallback((newState) => {
    v7_startTransition && startTransitionImpl ? startTransitionImpl(() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl, v7_startTransition]);
  React53.useLayoutEffect(() => history.listen(setState), [history, setState]);
  React53.useEffect(() => logV6DeprecationWarnings(future), [future]);
  return React53.createElement(Router, {
    basename,
    children: children2,
    location: state.location,
...
function Router(_ref5) {
  ...
  let navigationContext = React53.useMemo(() => ({
    basename,
    navigator: navigator2,
    static: staticProp,
    future: _extends6({
  ...
  let locationContext = React53.useMemo(() => {
  ...
  return React53.createElement(NavigationContext.Provider, {
    value: navigationContext
  }, React53.createElement(LocationContext.Provider, {
    children: children2,
...
function createRoutesFromChildren(children2, parentPath) {
  ...
  let routes = [];
  React53.Children.forEach(children2, (element, index2) => {
    if (!React53.isValidElement(element)) {
      return;
    }
    let treePath = [...parentPath, index2];
    if (element.type === React53.Fragment) {
...
var _excluded19 = ["onClick", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "viewTransition"];
var _excluded22 = ["aria-current", "caseSensitive", "className", "end", "style", "to", "viewTransition", "children"];
var _excluded32 = ["fetcherKey", "navigate", "reloadDocument", "replace", "state", "method", "action", "onSubmit", "relative", "preventScrollReset", "viewTransition"];
var REACT_ROUTER_VERSION = "6";
try {
  window.__reactRouterVersion = REACT_ROUTER_VERSION;
} catch (e) {
}
var ViewTransitionContext = React54.createContext({
  isTransitioning: false
});
if (true) {
  ViewTransitionContext.displayName = "ViewTransition";
}
var FetchersContext = React54.createContext(/* @__PURE__ */ new Map());
if (true) {
  FetchersContext.displayName = "Fetchers";
}
var START_TRANSITION2 = "startTransition";
var startTransitionImpl2 = React54[START_TRANSITION2];
var FLUSH_SYNC = "flushSync";
var flushSyncImpl = ReactDOM3[FLUSH_SYNC];
var USE_ID = "useId";
var useIdImpl = React54[USE_ID];
var MemoizedDataRoutes = React54.memo(DataRoutes);
...
function BrowserRouter(_ref4) {
  ...
  let history = historyRef.current;
  let [state, setStateImpl] = React54.useState({
    action: history.action,
    location: history.location
  });
  let {
  ...
  let setState = React54.useCallback((newState) => {
    v7_startTransition && startTransitionImpl2 ? startTransitionImpl2(() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl, v7_startTransition]);
  React54.useLayoutEffect(() => history.listen(setState), [history, setState]);
  React54.useEffect(() => logV6DeprecationWarnings(future), [future]);
  return React54.createElement(Router, {
    basename,
    children: children2,
    location: state.location,
    navigationType: state.action,
...
var Link = React54.forwardRef(function LinkWithRef2(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
    ...
    preventScrollReset,
    viewTransition
  } = _ref7, rest = _objectWithoutPropertiesLoose5(_ref7, _excluded19);
  let {
    basename
  } = React54.useContext(NavigationContext);
  let absoluteHref;
  ...
  return (
    ...
    React54.createElement("a", _extends7({}, rest, {
...
var NavLink = React54.forwardRef(function NavLinkWithRef(_ref8, ref) {
  let {
    ...
    viewTransition,
    children: children2
  } = _ref8, rest = _objectWithoutPropertiesLoose5(_ref8, _excluded22);
  let path = useResolvedPath(to3, {
    relative: rest.relative
  });
  let location = useLocation();
  let routerState = React54.useContext(DataRouterStateContext);
  let {
    navigator: navigator2,
    basename
  } = React54.useContext(NavigationContext);
  ...
  return React54.createElement(Link, _extends7({}, rest, {
...
var Form = React54.forwardRef((_ref9, forwardedRef) => {
  let {
    fetcherKey,
    navigate,
    reloadDocument,
    ...
    preventScrollReset,
    viewTransition
  } = _ref9, props = _objectWithoutPropertiesLoose5(_ref9, _excluded32);
  ...
  return React54.createElement("form", _extends7({
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
...
function useDataRouterContext2(hookName) {
  let ctx2 = React54.useContext(DataRouterContext);
  !ctx2 ? true ? invariant(false, getDataRouterConsoleError2(hookName)) : invariant(false) : void 0;
  return ctx2;
}
function useDataRouterState2(hookName) {
  let state = React54.useContext(DataRouterStateContext);
...
function useLinkClickHandler(to3, _temp) {
  ...
  }, [location, navigate, path, replaceProp, state, target, to3, preventScrollReset, relative, viewTransition]);
}
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = React54.useRef(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = React54.useRef(false);
  let location = useLocation();
  let searchParams = React54.useMemo(() => (
  ...
  let navigate = useNavigate();
  let setSearchParams = React54.useCallback((nextInit, navigateOptions) => {
...
function useSubmit() {
  ...
  return React54.useCallback(function(target, options) {
    if (options === void 0) {
      options = {};
    }
...
function useFormAction(action, _temp2) {
  ...
  let routeContext = React54.useContext(RouteContext);
  !routeContext ? true ? invariant(false, "useFormAction must be used inside a RouteContext") : invariant(false) : void 0;
  let [match] = routeContext.matches.slice(-1);
  let path = _extends7({}, useResolvedPath(action ? action : ".", {
    relative
  }));
  let location = useLocation();
  if (action == null) {
...
function useScrollRestoration(_temp4) {
  ...
  usePageHide(React54.useCallback(() => {
  ...
  if (typeof document !== "undefined") {
    ...
    React54.useLayoutEffect(() => {
      let getKeyWithoutBasename = getKey2 && basename !== "/" ? (location2, matches2) => getKey2(
...
function useViewTransitionState(to3, opts) {
  ...
  let vtContext = React54.useContext(ViewTransitionContext);
...
// node_modules/zmp-ui/esm/components/page/index.js
var _excluded20 = ["className", "id", "style", "children", "resetScroll", "hideScrollbar", "restoreScroll", "restoreScrollOnBack", "name"];
...
var AnimationRoutes = function AnimationRoutes2(props) {
  ...
  var routList = (0, import_react57.useMemo)(function() {
    return import_react57.Children.map(children2, function(child) {
      if (import_react57.default.isValidElement(child)) {
        var _child$props = child.props, element = _child$props.element, restProps = _objectWithoutPropertiesLoose(_child$props, _excluded21);
        if (!element || element.props.replace === true) return child;
        return _objectSpread11(_objectSpread11({}, child), {}, {
          props: _objectSpread11(_objectSpread11({}, restProps), {}, {
            element
          })
        });
      }
  ...
  if (animate) {
    direction.current = navigationType === Action2.Pop ? PAGE_TRANSITION_DIRECTION.BACKWARD : directionSetting || PAGE_TRANSITION_DIRECTION.FORWARD;
  }
...
var _excluded23 = ["className", "children", "style", "bold", "size"];
var Text = function Text2(props) {
  var _classNames;
  var className = props.className, children2 = props.children, style = props.style, bold = props.bold, size = props.size, rest = _objectWithoutPropertiesLoose(props, _excluded23);
...
var _excluded24 = ["className", "children", "style", "size"];
var Title = function Title2(props) {
  var _classNames;
  var className = props.className, children2 = props.children, style = props.style, size = props.size, rest = _objectWithoutPropertiesLoose(props, _excluded24);
...
var _excluded25 = ["className", "children", "style", "size"];
var HeaderText = function HeaderText2(props) {
  var _classNames;
  var className = props.className, children2 = props.children, style = props.style, size = props.size, rest = _objectWithoutPropertiesLoose(props, _excluded25);
...
// node_modules/zmp-ui/esm/components/box/index.js
var _excluded26 = ["id", "children", "className", "style", "m", "p", "mt", "ml", "mb", "mr", "mx", "my", "pt", "pl", "pb", "pr", "px", "py", "noSpace", "inline", "width", "height", "verticalAlign", "textAlign", "flex", "flexDirection", "flexWrap", "justifyContent", "alignItems", "alignContent"];
...
var Box = import_react61.default.forwardRef(function(props, ref) {
  ...
  var boxStyle = _objectSpread12({}, style || {});
  if (width) {
...
// node_modules/zmp-ui/esm/components/checkbox/Checkbox.js
var _excluded27 = ["className", "children", "disabled", "style", "defaultChecked", "size", "label", "indeterminate"];
...
var Checkbox = import_react64.default.forwardRef(function(props, ref) {
  ...
  var checkboxProps = _objectSpread13({}, restProps);
  if (checkboxGroup) {
  ...
  var handleOnChange = function handleOnChange2(e) {
    ...
    restProps.onChange == null || restProps.onChange({
      target: _objectSpread13(_objectSpread13({}, props), {}, {
...
var _excluded28 = ["className", "defaultValue", "children", "options", "onChange"];
var Group3 = import_react65.default.forwardRef(function(props, ref) {
  var className = props.className, defaultValue = props.defaultValue, children2 = props.children, _props$options = props.options, options = _props$options === void 0 ? [] : _props$options, onChange = props.onChange, restProps = _objectWithoutPropertiesLoose(props, _excluded28);
...
Group3.displayName = "zaui-checkbox-group";
...
// node_modules/zmp-ui/esm/components/radio/Radio.js
var _excluded29 = ["className", "children", "style", "disabled", "size", "label", "defaultChecked"];
...
var Radio = import_react67.default.forwardRef(function(props, ref) {
  ...
  var className = props.className, children2 = props.children, style = props.style, disabled = props.disabled, size = props.size, label = props.label, defaultChecked = props.defaultChecked, restProps = _objectWithoutPropertiesLoose(props, _excluded29);
  ...
  var radioProps = _objectSpread14({}, restProps);
...
var _excluded30 = ["className", "wrapperClassName", "size", "label"];
var Switch = import_react69.default.forwardRef(function(props, ref) {
  var _clsx, _clsx2;
  var className = props.className, wrapperClassName = props.wrapperClassName, size = props.size, label = props.label, rest = _objectWithoutPropertiesLoose(props, _excluded30);
...
var Progress = import_react70.default.forwardRef(function(props, ref) {
  ...
  var progressStyle = _objectSpread15({
    width: percent + "%"
  }, strokeStyle);
  if (strokeWidth) {
...
var Header = import_react76.default.forwardRef(function(props, ref) {
  ...
  var componentStyle = _objectSpread16({}, style);
  if (backgroundColor) {
...
function generateTrigger(PortalComponent) {
  var Trigger = function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      var cloneProps = _objectSpread17({}, newChildProps);
      if (supportRef(child)) {
...
var _excluded31 = ["children", "value"];
...
function convertNodeToOption(node) {
  var _ref = node, key = _ref.key, _ref$props = _ref.props, children2 = _ref$props.children, value = _ref$props.value, restProps = _objectWithoutPropertiesLoose(_ref$props, _excluded31);
...
function convertChildrenToData(nodes, optionOnly) {
  ...
  return toArray2(nodes).map(function(node, index2) {
    if (!React79.isValidElement(node) || !node.type) {
      return null;
    }
...
// node_modules/zmp-ui/esm/components/select/Select.js
var _excluded33 = ["className", "defaultOpen", "label", "status", "helperText", "errorText", "placeholder", "children", "defaultValue", "disabled", "mask", "maskCloseable", "multiple", "onChange", "closeOnSelect", "onVisibilityChange"];
...
var PickerColumn = function PickerColumn2(props) {
  ...
  (0, import_react92.useEffect)(function() {
    ...
    setState(function(prevState) {
      return _objectSpread20(_objectSpread20({}, prevState), newState);
    });
  }, [value, options]);
  var columnPrefixCls = prefixCls + "-column";
  var scrollerPrefixCls = prefixCls + "-scroller";
  var cls = clsx_m_default(columnPrefixCls, {}, className);
  var handleTouchStart = function handleTouchStart2(event) {
    var startYPos = event.targetTouches[0].pageY;
    setState(function(prevState) {
      return _objectSpread20(_objectSpread20({}, prevState), {}, {
        startTouchY: startYPos,
        startScrollerTranslate: prevState.scrollerTranslate
      });
    });
  };
  var handleItemClick = function handleItemClick2(option, colName) {
  ...
  var handleTouchEnd = function handleTouchEnd2() {
    ...
    setTimeout(function() {
      ...
      if (activeIndex === options.findIndex(function(opt) {
        ...
        setState(function(prevState) {
          return _objectSpread20(_objectSpread20({}, prevState), computeTranslate());
        });
      } else {
...
var Picker = function Picker2(props) {
  ...
  var handleChangePickerValue = function handleChangePickerValue2(otp, name) {
    ...
    var newState = _objectSpread21({}, pickerValue);
...
// node_modules/zmp-ui/esm/components/date-picker/index.js
var _excluded34 = ["inputClass", "suffix", "label", "placeholder", "status", "helperText", "errorText", "value", "defaultValue", "startDate", "onChange", "disabled", "onVisibilityChange", "endDate", "columnsFormat", "formatPickedValueDisplay", "locale", "dateFormat", "title"];
...
// node_modules/zmp-ui/esm/components/bottom-navigation/AnimatedBottomNavigationItem.js
var _excluded35 = ["linkTo", "onClick"];
var AnimatedBottomNavigationItem = import_react100.default.forwardRef(function(props, ref) {
  ...
  var linkTo = props.linkTo, onClick = props.onClick, rest = _objectWithoutPropertiesLoose(props, _excluded35);
...
// node_modules/zmp-ui/esm/components/bottom-navigation/BottomNavigation.js
var _excluded36 = ["key", "style", "className", "itemKey", "linkTo"];
...
var BottomNavigation = import_react101.default.forwardRef(function(props, ref) {
  ...
  var elStyle = _objectSpread24(_objectSpread24({}, style || {}), zIndex !== void 0 ? {
    zIndex
  } : {});
  return import_react101.default.createElement("div", {
    ...
    var key = item.key, tabStyle = item.style, tabClassName = item.className, itemKey = item.itemKey, linkTo = item.linkTo, restTabProps = _objectWithoutPropertiesLoose(item, _excluded36);
...
var getSlides = function getSlides2(children2, loop2) {
  ...
  if (loop2) {
    ...
    if (firstSlide) {
      slides.push(_objectSpread25(_objectSpread25({}, firstSlide), {}, {
        key: firstSlide.key + "-clone"
      }));
    }
    if (lastSlide) {
      slides.unshift(_objectSpread25(_objectSpread25({}, lastSlide), {}, {
...
var _excluded37 = ["children", "style", "className"];
var SwiperSlide = import_react104.default.forwardRef(function(props, ref) {
  var children2 = props.children, _props$style = props.style, style = _props$style === void 0 ? {} : _props$style, className = props.className, restProps = _objectWithoutPropertiesLoose(props, _excluded37);
...
var Swiper = import_react106.default.forwardRef(function(props, ref) {
  ...
  return import_react106.default.createElement(SwiperContext.Provider, {
    ...
    var slide = slides[i];
    var _slide$node$props = slide.node.props, slideStyle = _slide$node$props.style, rest = _objectWithoutPropertiesLoose(_slide$node$props, _excluded38);
    return import_react106.default.createElement(SwiperSlide_default, _extends({
      style: _objectSpread26(_objectSpread26({}, slideStyle), {}, {
        opacity
      })
    }, rest, {
      key: slide.key
...
var Image = import_react109.default.forwardRef(function(props, ref) {
  ...
  var handleDragImage = function handleDragImage2(_ref4) {
    var first = _ref4.first, _ref4$movement = _ref4.movement, mx = _ref4$movement[0], my = _ref4$movement[1], _ref4$memo = _ref4.memo, memo2 = _ref4$memo === void 0 ? [] : _ref4$memo;
  ...
  return import_react109.default.createElement("div", {
    ...
    src,
    alt,
    style: _objectSpread27({}, style)
  }, bind())));
});
var Image_default = Image;

// node_modules/zmp-ui/esm/components/image-viewer/index.js
var _excluded39 = ["images", "visible", "onClose", "activeIndex", "maskStyle", "maskClassName"];
...
var ImageViewer = import_react111.default.forwardRef(function(props, ref) {
  var images = props.images, visible = props.visible, onClose = props.onClose, defaultActiveIndex = props.activeIndex, maskStyle = props.maskStyle, maskClassName = props.maskClassName, rest = _objectWithoutPropertiesLoose(props, _excluded39);
...
var _excluded40 = ["id", "children", "className", "style", "space", "recursive", "splitAfter"];
...
var Stack = import_react113.default.forwardRef(function(props, ref) {
  var id = props.id, children2 = props.children, className = props.className, style = props.style, _props$space = props.space, space = _props$space === void 0 ? "var(--s1)" : _props$space, _props$recursive = props.recursive, recursive = _props$recursive === void 0 ? false : _props$recursive, splitAfter = props.splitAfter, rest = _objectWithoutPropertiesLoose(props, _excluded40);
  var prefixCls = getPrefixCls("stack");
  var classes = clsx_m_default(prefixCls, className);
  var stackStyle = _objectSpread29({}, style || {});
...
var _excluded41 = ["id", "children", "className", "style", "padding", "borderWidth", "invert"];
...
var _excluded42 = ["id", "children", "className", "style", "max", "andText", "gutters", "intrinsic"];
...
var _excluded43 = ["id", "children", "className", "style", "justify", "align", "space"];
...
var Cluster = import_react116.default.forwardRef(function(props, ref) {
  var id = props.id, children2 = props.children, className = props.className, style = props.style, _props$justify = props.justify, justify = _props$justify === void 0 ? "flex-start" : _props$justify, _props$align = props.align, align = _props$align === void 0 ? "flex-start" : _props$align, _props$space = props.space, space = _props$space === void 0 ? "var(--s1)" : _props$space, rest = _objectWithoutPropertiesLoose(props, _excluded43);
...
var _excluded44 = ["id", "children", "className", "style", "min", "columnCount", "rowSpace", "columnSpace"];
