...
import checkInHotData from "@/components/mock/dacsan.json";
 ...
 */
export default function FeaturedDacSan() {
      ...
      >
        {featuredSites.map((site, index) => (
          <SwiperSlide key={index}>
            <div onClick={() => navigate(`/dacsan/${index}`)} className="relative rounded-xl overflow-hidden cursor-pointer">
